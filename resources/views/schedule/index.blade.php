...
@section('head') --}}
    ...
    <title>Calendario de Pendientes</title>
            ...
            <div class="col-md-6">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button id="searchButton" class="btn btn-primary">{{__('Buscar')}}</button>
                    </div>
                </div>
            </div>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventDrop: function(info) {
                ...
                $.ajax({
                    ...
                    success: function() {
                        swal("¡Operación exitosa!", "La información ha sido movida correctamente.", "success")
